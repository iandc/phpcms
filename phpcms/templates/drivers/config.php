<?php return array(
    ...
    'file_explan' =>
        array(
            ...
            'templates|drivers|link' =>
                array(
                    'index.html' => '',
                    'list_type.html' => '分类页',
                    'register.html' => '申请页',
                ),
            'templates|drivers|special' =>
                array(
                    'api_picture.html' => '组图',
            ...
            'templates|drivers|announce' =>
                array(
                    'show.html' => '内容页',
                ),
            'templates|drivers|wap' =>
                array(
            ...
            'templates|drivers|phpsso' =>
                array(
                    'index.html' => '首页',
                ),
            'templates|drivers|search' =>
                array(
                    'footer.html' => '页尾',
                    'header.html' => '页头',
                    'index.html' => '首页',
            ...
            'templates|drivers|formguide' =>
                array(
                    'index.html' => '表单列表页模板',
                    'show.html' => '表单详情页模板',
                    'show_js.html' => '表单js调用模板',
                ),
            'templates|drivers|mood' =>
                array(
                    'index.html' => '新闻心情',
                ),
            'templates|drivers|yp' =>
                array(
                    'com_default' => '企业默认模板',
                    'index.html' => '黄页首页模板',
                    'list.html' => '列表页模板',
            ...
            'templates|drivers|yp|com_default' =>
                array(
                    'index.html' => '公司首页模板',
                    'style' => '样式文件夹',
                ),
            'templates|drivers|comment' =>
                array(
