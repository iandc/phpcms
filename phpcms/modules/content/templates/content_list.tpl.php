                ...
                <tr>
                    <td>
                        <div class="explain-col">
                            ...
                            <select name="posids">
                                <option value='' <?php if ($_GET['posids'] == '') echo 'selected'; ?>><?php echo L('all'); ?></option>
    ...
    <form name="myform" id="myform" action="" method="post">
        <div class="table-list">
            ...
            <div class="btn"><label for="check_box"><?php echo L('selected_all'); ?>/<?php echo L('cancel'); ?></label>
                ...
                <select id="type_select" name="type_select" onchange="moveType(this.value)">
                    <option value="0">请选择要移动到的分类</option>
                    <?php foreach ($typeList as $value) { ?>
                        <option value="<?php echo $value['typeid']; ?>"><?php echo $value['name']; ?></option>
                    <?php } ?>
                </select>
...
<script type="text/javascript">
    ...
    function moveType(typeid) {
        ...
        if (typeid == 0) {
            alert('<?php echo L('you_do_not_select_type');?>');
            return false;
        }

        var url = "index.php?m=content&c=content&a=moveType";
        var para = "&typeid=" + typeid + "&ids=" + ids + "&catid=<?php echo $catid;?>";
        var hash = "&pc_hash=<?php echo $_SESSION['pc_hash'];?>";
        url += para;
        url += hash;
