...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"http://www.eetop.cn/adi/power/images/bg.png", id:"bg"},
		{src:"http://www.eetop.cn/adi/power/images/CorpPower_640x480_1.jpg", id:"CorpPower_640x480_1"},
		{src:"http://www.eetop.cn/adi/power/images/txt1.png", id:"txt1"},
		{src:"http://www.eetop.cn/adi/power/images/txt2.png", id:"txt2"},
		{src:"http://www.eetop.cn/adi/power/images/txt4.png", id:"txt4"}
	]
};
...
(lib.CorpPower_640x480_1 = function() {
	this.initialize(img.CorpPower_640x480_1);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,267,28);
...
p.nominalBounds = new cjs.Rectangle(0,20,178,28);
...
// stage content:
(lib.CorpPower_640x480 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get(this.btn_main).wait(199));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(177).to({_off:false},0).to({alpha:1},11).wait(11));
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(52).to({graphics:mask_graphics_52,x:315.7,y:232.3}).wait(147));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(124).to({_off:false},0).to({x:342},12,cjs.Ease.get(1)).wait(32).to({y:502.6},10,cjs.Ease.get(1)).wait(21));

	// HL1
	this.instance_2 = new lib.HL1();
	this.instance_2.setTransform(780,493,1,1,0,0,0,150,125);
	this.instance_2._off = true;

	this.instance_2.mask = mask;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(52).to({_off:false},0).to({x:342},12,cjs.Ease.get(1)).wait(47).to({x:22},13,cjs.Ease.get(-1)).wait(75));

	// Icon copy
	this.instance_3 = new lib.Icon();
	this.instance_3.setTransform(140,243,1,1,0,0,0,150,125);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(17).to({_off:false},0).to({alpha:1},11).wait(171));

	// Logo
	this.instance_4 = new lib.Logo();
	this.instance_4.setTransform(331.6,71,1.001,1,0,0,0,77.3,32.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(199));

	// BG
	this.instance_5 = new lib.CorpPower_640x480_1();

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(199));
